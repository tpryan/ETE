...
internal class _SessionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("name", "description", "starttime", "endtime", "location", "speaker");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("name", "description", "starttime", "endtime", "location", "speaker");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("name", "description", "starttime", "endtime", "location", "speaker");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("name", "description", "starttime", "endtime", "location", "speaker");
    ...
    public function _SessionEntityMetadata(value : _Super_Session)
    {
        ...
        model_internal::propertyTypeMap["speaker"] = "String";
